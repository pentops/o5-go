...
func (msg *ListEnvironmentsRequest) MessagingHeaders() map[string]string {
	headers := map[string]string{
		"grpc-service": "/o5.deployer.v1.service.DeploymentQueryService/ListEnvironments",
		"grpc-message": "o5.deployer.v1.service.ListEnvironmentsRequest",
	}
	return headers
}
...
func (msg *GetEnvironmentRequest) MessagingHeaders() map[string]string {
	headers := map[string]string{
		"grpc-service": "/o5.deployer.v1.service.DeploymentQueryService/GetEnvironment",
		"grpc-message": "o5.deployer.v1.service.GetEnvironmentRequest",
	}
	return headers
}
...
func (msg *ListEnvironmentEventsRequest) MessagingHeaders() map[string]string {
	headers := map[string]string{
		"grpc-service": "/o5.deployer.v1.service.DeploymentQueryService/ListEnvironmentEvents",
		"grpc-message": "o5.deployer.v1.service.ListEnvironmentEventsRequest",
	}
	return headers
}
