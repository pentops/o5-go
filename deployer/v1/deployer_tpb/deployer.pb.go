...
var file_o5_deployer_v1_topic_deployer_proto_rawDesc = []byte{
	...
	0x01, 0x01, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xd5, 0x02, 0x0a,
	0x0d, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x65, 0x72, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x12, 0x5d,
	...
	0x67, 0x65, 0x64, 0x12, 0x2f, 0x2e, 0x6f, 0x35, 0x2e, 0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x65,
	...
	,
	...
	0x6c, 0x6f, 0x79, 0x65, 0x72, 0x5f, 0x74, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_o5_deployer_v1_topic_deployer_proto_goTypes = []interface{}{
	...
	(*StackID)(nil),                          // 4: o5.deployer.v1.topic.StackID
	(*deployer_pb.KeyValue)(nil),             // 5: o5.deployer.v1.KeyValue
	(deployer_pb.StackLifecycle)(0),          // 6: o5.deployer.v1.StackLifecycle
	(deployer_pb.DatabaseMigrationStatus)(0), // 7: o5.deployer.v1.DatabaseMigrationStatus
...
var file_o5_deployer_v1_topic_deployer_proto_depIdxs = []int32{
	...
	4, // 1: o5.deployer.v1.topic.StackStatusChangedMessage.stack_id:type_name -> o5.deployer.v1.topic.StackID
	5, // 2: o5.deployer.v1.topic.StackStatusChangedMessage.outputs:type_name -> o5.deployer.v1.KeyValue
	6, // 3: o5.deployer.v1.topic.StackStatusChangedMessage.lifecycle:type_name -> o5.deployer.v1.StackLifecycle
	7, // 4: o5.deployer.v1.topic.MigrationStatusChangedMessage.status:type_name -> o5.deployer.v1.DatabaseMigrationStatus
	0, // 5: o5.deployer.v1.topic.DeployerTopic.TriggerDeployment:input_type -> o5.deployer.v1.topic.TriggerDeploymentMessage
	1, // 6: o5.deployer.v1.topic.DeployerTopic.StackStatusChanged:input_type -> o5.deployer.v1.topic.StackStatusChangedMessage
	2, // 7: o5.deployer.v1.topic.DeployerTopic.MigrationStatusChanged:input_type -> o5.deployer.v1.topic.MigrationStatusChangedMessage
	8, // 8: o5.deployer.v1.topic.DeployerTopic.TriggerDeployment:output_type -> google.protobuf.Empty
	8, // 9: o5.deployer.v1.topic.DeployerTopic.StackStatusChanged:output_type -> google.protobuf.Empty
	8, // 10: o5.deployer.v1.topic.DeployerTopic.MigrationStatusChanged:output_type -> google.protobuf.Empty
